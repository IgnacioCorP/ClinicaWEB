...
<html>
    ...
    <body>
        ...
        <div class="container h-100 py-4">
            <div class="d-flex justify-content-center h-100">
                <div class="searchbar ">
                    <form method="POST" action="Laboratorio?accion=buscar">
    ...
    <div class="row  d-flex justify-content-center "
        ...
        <div class="container-fluid col-sm-12 col-md-6" >
            <h1 style="justify-content: center; display: flex; color: white; padding-top: 100px">LABORATORIOS</h1>
            <div class="card mb-3" style="max-width: 800px;">
                <div class="row g-0">
                    <c:forEach items="${laboratorios}" var="laboratorio" >
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">${laboratorio.getIDlab()}</h5>
                                <p class="card-text">${laboratorio.getNombresede()}</p>
                                <p class="card-text"><small class="text-muted">${laboratorio.getDireccion()}</small></p>
                                <p class="card-text"><small class="text-muted">${laboratorio.getTelefono()}</small></p>
